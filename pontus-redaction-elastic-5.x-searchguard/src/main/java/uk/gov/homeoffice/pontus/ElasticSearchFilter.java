...
//                User elasticSearchGuardUser = request.getFromContext(ConfigConstants.SG_USER);
                User elasticSearchGuardUser = threadContext.getTransient(ConfigConstants.SG_USER);
...
//            }
                ...
                userStr = threadContext.getTransient("shield.user") ; // request.getFromContext("shield.user");

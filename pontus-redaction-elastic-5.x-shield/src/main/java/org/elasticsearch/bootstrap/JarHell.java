...
public class JarHell {
    ...
    public static final Log LOG = LogFactory.getLog(JarHell.class);
    ...
    public static void checkJarHell() throws Exception {
        ...
        if (LOG.isDebugEnabled()) {
            ...
            LOG.debug(String.format("sun.boot.class.path: %s", System.getProperty("sun.boot.class.path")));
            if (loader instanceof URLClassLoader ) {
                LOG.debug(String.format("classloader urls: %s", Arrays.toString(((URLClassLoader)loader).getURLs())));
            }
        }
    ...
    public static void checkJarHell(URL urls[]) throws Exception {
        ...
        LOG.debug(String.format("java.home: %s", javaHome));
        ...
        for (final URL url : urls) {
            ...
            if (path.startsWith(javaHome)) {
                LOG.debug(String.format("excluding system resource: %s", path));
                continue;
            }
            if (path.toString().endsWith(".jar")) {
                if (!seenJars.add(path)) {
                    LOG.debug(String.format("excluding duplicate classpath element: %s", path));
                    continue; // we can't fail because of sheistiness with joda-time
                }
                LOG.debug(String.format("examining jar: %s", path));
                ...
                LOG.debug(String.format("examining directory: %s", path));

...
import static org.elasticsearch.bootstrap.PontusElasticEmbeddedKafkaSubscriber.ENABLE_PLUGIN_CONF;

/**
 * Internal startup code.  Hacked (see all the LPPM comments)
 */
final class Bootstrap {
    ...
    private void setup(boolean addShutdownHook, Environment environment) throws BootstrapException {
        ...
        // LPPM - this security manager is interfering with Kafka, disabling for now...
...
//        }
        ...
        // LPPM: Force-feed the classpathPlugins below:
        Collection<Class<? extends Plugin>> classpathPlugins = new ArrayList<>();

        if (Boolean.parseBoolean(System.getProperties().getProperty(ENABLE_PLUGIN_CONF,"true"))) {
//            classpathPlugins.add(com.floragunn.searchguard.SearchGuardPlugin.class);
        ...
        // LPPM: the original did not have the second argument:
        //node = new Node(environment) {


        node = new Node(environment, classpathPlugins) {
            @Override
    ...
    //LPPM - added this so we can get the node

...
public class PoleFilterRedactOnly extends FilterBase {
    ...
    public PoleFilterRedactOnly(User user, TableName table, FilterData patterns) {
        this.user = user;
        this.table = table;
    ...
    public void filterRowCells(List<Cell> kvs) throws IOException {
        PoleSecurityCoprocessor.filterRedaction(user,table,kvs,patterns);
    }
    ...
    public boolean equals(Object o) {
        ...
        PoleFilterRedactOnly that = (PoleFilterRedactOnly) o;

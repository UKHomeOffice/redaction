 ...
 *
 */
public class SolrPoleSecurityCSVResponseWriterFilter implements QueryResponseWriter {
    @Override
    ...
    public void write(Writer writer, SolrQueryRequest req, SolrQueryResponse rsp) throws IOException {
        SolrPoleSecurityCSVWriterFilter w = null;
        try {
            w = new SolrPoleSecurityCSVWriterFilter(writer, req, rsp);
            w.writeResponse();

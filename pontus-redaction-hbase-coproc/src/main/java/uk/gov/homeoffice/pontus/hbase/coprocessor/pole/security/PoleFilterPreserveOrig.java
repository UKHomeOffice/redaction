...
public class PoleFilterPreserveOrig extends FilterBase {
    ...
    public PoleFilterPreserveOrig(Filter orig, User user, TableName table, FilterData patterns) {
        this.orig = orig;
        this.user = user;
        this.table = table;
    ...
    public boolean equals(Object o) {
        ...
        PoleFilterPreserveOrig that = (PoleFilterPreserveOrig) o;

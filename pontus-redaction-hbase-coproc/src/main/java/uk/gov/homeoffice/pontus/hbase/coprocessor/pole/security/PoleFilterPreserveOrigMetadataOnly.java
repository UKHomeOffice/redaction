...
public class PoleFilterPreserveOrigMetadataOnly extends FilterBase {
    ...
    public PoleFilterPreserveOrigMetadataOnly(Filter orig, User user, TableName table, FilterData patterns) {
        this.orig = orig;
        this.user = user;
        this.table = table;
    ...
    public boolean equals(Object o) {
        ...
        PoleFilterPreserveOrigMetadataOnly that = (PoleFilterPreserveOrigMetadataOnly) o;

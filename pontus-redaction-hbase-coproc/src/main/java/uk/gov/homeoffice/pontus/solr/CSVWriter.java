...
public class CSVWriter extends TextResponseWriter {
    ...
    static class ResettableFastWriter extends FastWriter {
        CSVWriter.OpenCharArrayWriter cw = new CSVWriter.OpenCharArrayWriter();
        char[] result;
        int resultLen;

        public ResettableFastWriter() {
            super(new CSVWriter.OpenCharArrayWriter());
            cw = (CSVWriter.OpenCharArrayWriter)sink;
        }
    ...
    static class CSVField {
        String name;
        SchemaField sf;
        CSVWriter.CSVSharedBufPrinter mvPrinter;  // printer used to encode multiple values in a single CSV value
    ...
    int pass;
    Map<String,CSVWriter.CSVField> csvFields = new LinkedHashMap<>();

    Calendar cal;  // for formatting date objects

    CSVStrategy strategy;  // strategy for encoding the fields of documents
    CSVPrinter printer;
    CSVWriter.ResettableFastWriter mvWriter = new CSVWriter.ResettableFastWriter();  // writer used for multi-valued fields
    ...
    public void writeResponse() throws IOException {
        ...
        CSVWriter.CSVSharedBufPrinter csvPrinterMV = new CSVWriter.CSVSharedBufPrinter(mvWriter, mvStrategy);
        ...
        for (String field : fields) {
            ...
            if (field.equals("score")) {
                CSVWriter.CSVField csvField = new CSVWriter.CSVField();
                csvField.name = "score";
            ...
            CSVWriter.CSVSharedBufPrinter csvPrinter = csvPrinterMV;
            if (sep != null || encapsulator != null || escape != null) {
                ...
                csvPrinter = new CSVWriter.CSVSharedBufPrinter(mvWriter, strat);
            }
        ...
        if (params.getBool(CSV_HEADER, true)) {
            for (CSVWriter.CSVField csvField : csvFields.values()) {

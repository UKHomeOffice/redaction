 ...
 *
 */
public class SolrPoleSecurityJSONResponseWriterFilter implements QueryResponseWriter {
    @Override
    ...
    public void write(Writer writer, SolrQueryRequest req, SolrQueryResponse rsp) throws IOException {
        SolrPoleSecurityJSONWriterFilter w = null;
        try {
            w = new SolrPoleSecurityJSONWriterFilter(writer, req, rsp);
            w.writeResponse();
